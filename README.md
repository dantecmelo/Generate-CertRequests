...
* Requires the CertificateServicesAdministration module (RSAT-ADCS-Tools) on the machine running the script if using 'New-CertificateRequest' directly with CA submission. However, this script uses 'certreq.exe' for submission, which is generally available.
